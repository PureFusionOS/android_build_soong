...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.ProductVariables.Pure.Specific_camera_parameter_library)
}
...
func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.ProductVariables.Pure.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.ProductVariables.Pure.QTIDisplayPath)
}
